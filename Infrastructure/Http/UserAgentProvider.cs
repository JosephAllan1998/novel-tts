...
{
    /// <summary>
    /// Provides randomised User-Agent strings to reduce bot detection.
    /// </summary>
    public static class UserAgentProvider
    {
        private static readonly Random _rnd = new Random();

        private static readonly List<string> _agents = new List<string>
        {
            ...
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 YaBrowser/24.4.3.933 Yowser/2.5 Safari/537.36",
        ...
        public static string GetRandom()
        {
            lock (_rnd)
            {
                return _agents[_rnd.Next(_agents.Count)];
            }
        }
    }
}
